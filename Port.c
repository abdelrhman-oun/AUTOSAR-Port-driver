...
#endif
	{
		...
		for (i = 0; i < 43; i++)
		{
			...
			*/
			...
			if (ConfigPtr->Pins[i].mode == 10u) /* DIO mode*/
			{
			...
			else if (ConfigPtr->Pins[i].mode == 00u) /* Analog mode */
			{
